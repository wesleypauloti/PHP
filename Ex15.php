...
<body>
    <main>
        <?php 
            $n1 = $_REQUEST["n1"] ?? 1; 
            $resultado = $n1 * (180/3.14);    
        ?>
        <pre>
            <h1>Gerador de Resultado na mesma Página</h1>
            <form action="<?=$_SERVER['PHP_SELF'] ?>" method="post">
                <h2 class="equacao">Conversão de um ângulo em radianos para graus</h2>
        ...
        <section>
            <h2>Resultado</h2>
            <?php
                echo "$n1 radianos do ângulo equivalem a " . number_format($resultado, 2) . " graus";
            ?>
